...
{
    //7
    question: 'la dérivée de la fonction f définie par \n          f (t) =   (2ln⁡(1+√(t)))/(1+√t) est(هي):',
    questionAR : '   المعرفة بما يلي  f الدالة المشتقة للدالة\n' +
        '         f (t) =   (2ln⁡(1+√(t)))/(1+√t) est(هي):\n',
    answers: [
    'f’ (t) =   (1- ln⁡(1+√(t)))/(√t(1+√(t)))',
    'f’ (t) =   (1- ln⁡(1+√(t)))/(2(1+√(t)) ²)',
    ...
    },
{
    ...
    question: 'Soit f la fonction définie par :\t f(x)=  x/(x+1) ∛(1+x²)',
        questionAR:'  المعرفة كما يلي  الدالة f \n' +
            'f(x)=  x/(x+1) ∛(1+x²)\n ',
    answers: [
    'lim┬(x→-∞)⁡〖f(x)= 0〗',
    'lim┬(x→-∞)⁡〖f(x)= 1〗  ',
...
},
{
    ...
    question: 'Si la suite (Vn) n’est pas majorée elle diverge nécessairement vers +∞',
        questionAR : 'اذا كانت المتتالية غير مكبورة فهي متباعدة\n' +
            '+∞ في\n',
    answers: [
        'Vrai / صحيح',
        'Faux / خطأ',
...
},
{
    ...
    question: 'La fonction 4cosx n’a pas de primitive sur R',
        questionAR : 'R  لا تقبل دالة اصلية على4cosx  الدالة',
    answers: [
    'Vrai / صحيح',
    'Faux / خطأ',
    '',
...
},
{
    ...
    question: 'L’ensemble de définition de la fonction\n',
        questionAR :  'الدالة  مجموعة تعريف\n' +
            'f(x)=〖log〗_2 (x)+〖log〗_x (2)est هو :\n ',
    answers: [
    'R',
    ']-∞;-1[∪]1 +∞[',
    'R*',
...
},
{
    ...
    question: 'Soit 〖(Un)〗_(n≥1)la suite géométrique de premier terme U_1=2 et de raison  q= 1/3 alors :',
        questionAR :'〖(Un)〗_(n≥1) لتكن\n' +
            'المتتالية الهندسية ذات الحد الاول\n' +
            ' U_1=2 و q= 1/3\n',
    answers: [
...
{
    //30
    question: 'i f est paire alors (Cf)admet l^\' axe des \n' +
        'ordonées comme axe de symétrie \n',
        questionAR :'(Cf) اذا كانت دالة زوجية اذن\n' +
            ' يقبل محور الاراتيب كمحور تماثل\n',
    answers: [
    'Vrai / صحيح',
    'Faux / خطأ',
    '',
