export default [
    ...
    },
    {
        ...
        answers: [
            'Est la fonction f  ̄¹ est continue sur f(]a ;b[)',
            'La fonction f  ̄¹ est définie sur ]lim┬(x→a˖)⁡〖f(a) ;〗   lim┬(x→b  ̄)⁡〖f(b)[〗',
    ...
    },
    {
        ...
        answers: [
            'La fonction f  ̄¹ définie sur [1 ; +∞[ par f  ̄¹( x)= -√(x-1)',
            'La fonction f  ̄¹ définie sur ]1 ; +∞[ par f  ̄¹( x)= √(x-1)',
            'La fonction f  ̄¹ définie sur [1 ; +∞[ par f  ̄¹( x)= √(x-1)',
            'Continue sur [1 ; +∞['
        ],
    ...
    },
    {
        ...
        answers: [
            'Est Continue sur ]- ∞;-1] et [1;+∞[ ',
            'Est non continue en en 1',
            'Est non continue en -1',
            'Est continue en R'
        ],
        correct: 4
    },
